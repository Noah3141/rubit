...
import type { VerbEntry } from "~/types/ukrainian/list/verb";
import type { AdjEntry } from "~/types/ukrainian/list/adjective";
import type { NounEntry } from "~/types/ukrainian/list/noun";
