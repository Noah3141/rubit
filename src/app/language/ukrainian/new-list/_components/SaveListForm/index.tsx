...
import { VocabularyListData } from "~/types/ukrainian/list";
...
const SaveListForm: FC<{
    ...
    const saveList = api.list.ukrainian.save.useMutation({
        onMutate: () => {
        ...
        onSuccess: (newList) => {
            router.push(`/language/ukrainian/my-lists/${newList.id}`);
