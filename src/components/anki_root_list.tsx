    ...
    return (
        <div>
            <ol type="1" className="list-decimal">
                ...
                <li>
                    в<u>е</u>сить (-вешивать) to weigh, to hang вешать - to hang
                    (execute)
                </li>
                <li>
                ...
                <li>
                    с<u>ы</u>пать (-<u>а</u>ть) to pour (of solids, e.g. grains,
                    sands, money) с<u>ы</u>пать &gt; обс
                ...
                <li>
                    ...
                    (direct something to a position) <br />
                    Note that stress contrasts aspect when using -дв<u>и</u>гать
                    for Branch forms: <br />
                    perf. продв
                ...
                <li>
                    п<u>о</u>мнить (-помин<u>а</u>ть) to remember, recollect,
                    keep in mind
                </li>
                <li>
                ...
                <li>
                    ...
                    ; <br />
                    "Whenever an -еть verb is made from an adjective, as occurs
                    here, in the meaning "to become that adjective", the
                    conjugation is -<u>е</u>ю, -<u>е</u>ешь, -<u>е</u>ют."
                </li>
                <li>
                ...
                <li>
                    {" "}
                    These are not a pair, both are potential roots, садить and
                    сажать. <br />
                    Mostly садить is the main root, сажать is also possible, but
                    because it causes branch-confusion, is less widespread.{" "}
                    <br />
                    e.g. досаж
                ...
                <li>
                    в<u>и</u>снуть (-вис<u>а</u>ть) (intransitive) to hang (have
                    a position off an edge) See весить for transitive.
                </li>
                ...
                <li>
                    ...
                    придраться \ придираться - to undeservedly find fault, to
                    rebuke for small or apparent guilt; к чему, к кому
                </li>
                <li>
                ...
                <li>
                    п<u>а</u>дать / пасть (-пад<u>а</u>ть) to fall (lose
                ...
                <li>
                    р<u>е</u>зать (-рез<u>а</u>ть, -резывать) to cut, slice,
                    carve <br />
                    вр<u>е</u>
                ...
                <li>
                    г<u>а</u>снуть (-гас<u>а</u>ть) to go out (of fire, lights),
                    to die away
                </li>
                ...
                <li>
                    ...
                    grasp, snatch; <br />
                    (impersonal) to suffice, to be enough For second sense:
                    кому, или у кого, хватит чего
                </li>
                <li>
                ...
                <li>
                    {" "}
                    соприкоснуться / соприкасаться - to come into contact with,
                    to touch, to be contiguous
                    <br />
                ...
                <li>
                    п<u>я</u>лить (-пяливать) to stretch, to stretch tight;
                    (idiomatic) пялить глаза - to stare
                </li>
                ...
                <li>
                    м<u>е</u>тить (-мечать) to mark, label "наметить / намечать
                    - "mark up", put on markings/labels"
                </li>
                <li>крыть (-крывать) to cover</li>
                <li>
                    с<u>луш</u>ать (-слушивать) to listen "вслушаться /
                ...
                <li>
                    т<u>и</u>скать / т<u>и</u>снуть (-тискивать) to squeeze,
                    snuggle, print "протискиваться - to squeeze/elbow one's way
                    through (e.g. a crowd)"
                </li>
                ...
                <li>
                    в<u>е</u>ять (-веивать, -вевать) to blow gently, drift, wave
                    or flutter
                </li>
                <li>
                    pf. купить (-купать) to buy <br />
                    Infrequent case of a lone -ить Root Verb being perfective.
                    Rest of tree looks as expected.
                </li>
                ...
                <li>
                    ...
                    <br />
                    достать / доставать - to get, to take out, retrieve, to
                    attain, obtain
                    <br />
                ...
                <li>
                    н<u>и</u>кнуть (-ник<u>а</u>ть) to hang down, wither, droop*
                    "*Very odd word to try to define,
                    <br />
                    Few main uses are:
                    <br />
                    проникнуть / проникать - to penetrate, perforate, permeate
                    <br />
                    возникнуть / возникать - to arise, appear, emerge, to spring
                    up "Возник вопрос... Кто я такой?"
                    <br />
                    вникнуть / вникать - to penetrate, to delve into, to
                    consider carefully"
                </li>
                ...
                <li>
                    т<u>о</u>пать / т<u>о</u>пнуть (-топывать) "to stomp, to
                    stamp one's foot"
                </li>
                <li>
                ...
                <li>
                    м<u>а</u>зать (-мазывать) Actions to do with a viscous
                    liquid being moved, applied, etc. Better than a definition,
                    see some of the more specified prefixed meanings:
                    <br />
                    см<u>а</u>зать / смазывать - apply grease; wipe off; to blur
                    a photo; to diminish clarity
                    <br />
                    замазать
                </li>
                <li>
                ...
                <li>
                    в<u>е</u>дать (-ведывать, -в<u>е</u>довать) [archaic root]
                    to know; to govern, manage control Root itself is
                ...
                <li>
                    переть (-пирать) <br />
                    intransitive: to go (ignoring obstacles or prohibitions,
                    often long journey)
                    <br />
                ...
                <li>
                    ...
                    <br />
                    While "глотить" on its own is not seen, understandably the
                    tree takes the form:
                    <br />
                    <i>Root Verbs</i>: глотать / глотнуть
                    <br />
                    <i>Branch Verbs</i>: заглотать / заглатывать and sometimes
                    the pattern поглотить / поглащать
                    <br />
                    The most common perfective, for simple reasons, is
                ...
                <li>
                    ...
                    <br />
                    расспросить / расспрашивать - ask apart, delive rmultiple
                    questions with an aim to find something out
                    <br />
                    спросить / спрашивать - to ask a question (request down from
                    someone's mind)
                    <br />в<u>ы</u>просить / выпрашивать - receive or achieve by
                    intensive requesting
                    <br />
                    запросить / запрашивать - to overask (to sell for an
                    unreasonable high price) etc.
                    <br />
                    порасспросить / порасспрашивать - to spend some time asking
                    apart by question
                    <br />
                    по-рас-с-просить"
                </li>
                ...
                <li>
                    ...
                    (therefore visible)
                    <br />
                    'яснить' in and of itself is practically not a real word
                    (ясниться exists)--the point is that a tree exists with many
                    useful words:
                    <br />
                    ...
                    <br />
                    разъяснить / разъяснять - remove unclarity, make clear
                    (parse)
                    <br />
                    объяснить / объяснять - to explain
                    <br />
                    уяснить / уяснять - make clear, understandable, come to
                    understand
                    <br />
                    The difference between forms is, of course, subtle,
                ...
                <li>
                    п<u>и</u>скнуть / пищ<u>а</u>ть (-пискивать) to squeak, to
                    peep
                </li>
                ...
                <li>
                    {" "}
                    превратить(ся) / превращать(ся) - to turn (into something -
                    во что)
                </li>
                <li>
                    {" "}
                    отвратить / отвращать - to turn offward, ward off, avert
                </li>
                ...
                <li>
                    {" "}
                    различить(ся) / различать(ся) - to distinguish, tell apart,
                    discriminate
                </li>
